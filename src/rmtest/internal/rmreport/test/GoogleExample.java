...
import rmtest.internal.rmreport.nav.BaseNav;
...
//	    	return DriverProvider.getDrivers(Platform.ANDROID);
	    ...
	    public void beforeTest(){
	    	...
	    	nav = new BaseNav(tDriver);
	    }
	    
    @Test
    public void logoIsDisplayed() throws Exception {
    	WebElement redmindLogo = nav.getRedmindLogo();
    	assertTrue(redmindLogo.isDisplayed());
    }
    
    @Test
    public void graphMenuIsDisplayed() throws Exception {
    	WebElement graphMenu = nav.getGraphMenu();
    	assertTrue(graphMenu.isDisplayed());
    }
    
    @Test
    public void screenshotMenuIsDisplaed(){
    	WebElement screenshotMenu = nav.getScreenshotMenu();
    	assertTrue(screenshotMenu.isDisplayed());
    }
